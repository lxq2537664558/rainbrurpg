...
<?php
/** \file movedownattrb.php
  * Defines a form used to move down an attribute
  * 
  * Modifications :
...
function delAttrb(){
  ...
  if(!empty($name)){
    ...
    $xmlattrb->moveDownAttrb($attrbNote);
...
<HTML>
  ...
  <body>
    <h1>Move down attribute</h1>
   <form action="movedownattrb.php" method="post">
