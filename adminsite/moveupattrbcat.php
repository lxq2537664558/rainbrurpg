...
<?php
/** \file moveupattrbcat.php
  * Defines a form used to move up an attribute category
  * 
  * Modifications :
...
<HTML>
  ...
  <body>
    <h1>Move Up attributes category</h1>
   <form action="moveupattrbcat.php" method="post">
