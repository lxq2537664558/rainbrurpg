...
<?php
/** \file deleteattrbcat.php
  * Defines a page used to delete an attribute's category
  * 
  * Modifications :
...
/** Deletes an attribute
  *
  * Only the attribute's category name is needed from the HTTP POST or GET 
  * protocol.
  *
  */
...
<HTML>
  ...
  <body>
    <h1>Delete attributes category</h1>
   <form action="deleteattrbcat.php" method="post">
