...
/** The destructor of the game state
  *
  */
void RainbruRPG::Core::gsCreateAccount::cleanup(){
...
/** The drawing method
  ...
  *
  */
void RainbruRPG::Core::gsCreateAccount::run(){
...
/** Creates the gui of the game GameState
  ...
  * Do nothing.
  */
void RainbruRPG::Core::gsCreateAccount::createGui(){
 ...
 IGUIWindow*win= irrGui->addWindow( rect<s32>( x1, y1, x2, y2), false, 
				    L"Account creation", irrTab, 1002);
 ...
 // Password
 irrGui->addStaticText(L"Password", rect<s32>(10,45,190,65), 
 		       false, true, win);
 ...
 // Repeat password
 irrGui->addStaticText(L"Repeat password", rect<s32>(10,70,190,90), 
 		       false, true, win);
 ...
 // EMail adress
 irrGui->addStaticText(L"Email adress", rect<s32>(10,95,190,115), 
 		       false, true, win);

 irrGui->addEditBox (L"", rect<s32>(200,95,390,115), true, win, 11);

 // Caution
 irrGui->addStaticText(L"You are about to create a new account. All fields "
		       "are required and you must wait your adress's "
		       "confirmation to be able to play.\n"
		       "\n"
		       "A mail will be send to this mail adress and you "
		       "must answer to this to confirm that this mail adress "
		       "exist.\n"
		       "\n"
		       "An adress cannot be used for differents accounts." , 
		       rect<s32>(10,125,390,250), 
 		       true, true, win);



 // Connect&create button
 irrGui->addButton(rect<s32>(xBtn+25,260,xBtn+140,280), win, 101, L"Create" );
 irrGui->addButton(rect<s32>(10,260,100,280), win, 102, 
		   L"Back" );
