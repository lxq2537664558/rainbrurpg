...
#ifdef SIZE_MAX
/** \def SIZE_MAX
  * Define as the maximum value of type \c size_t, if the system 
  * doesn't define it. 
  */
#endif // SIZE_MAX

#ifdef INTDIV0_RAISES_SIGFPE
/** \def INTDIV0_RAISES_SIGFPE
...
/** \def HAVE___FSETLOCKING
  * Define to 1 if you have the \c __fsetlocking function. 
  *
  * The \c __fsetlocking function, declared in the \c stdio_ext.h header,
  * is used to select the desired type of locking on a stream.
  *
  */
#endif // HAVE___FSETLOCKING

#ifdef HAVE_WINT_T
/** \def HAVE_WINT_T
  * Define if you have the \c wint_t type. 
  *
  * The \c wint_t type, declared in the \c wchar.h header, is an integral
  * type capable of storing any valid value of \c wchar_t or \c WEOF.
  */
#endif // HAVE_WINT_T

#ifdef HAVE_WCSLEN
/** \def HAVE_WCSLEN
  * Define to 1 if you have the \c wcslen function. 
  *
  * The \c wcslen function return the number of characters of a 
...
#ifdef HAVE_WCHAR_T
/** \def HAVE_WCHAR_T
  * Define if you have the \c wchar_t, wide character type. 
  */
#endif // !HAVE_WCHAR_T
...
/** \def HAVE_UNSIGNED_LONG_LONG_INT
