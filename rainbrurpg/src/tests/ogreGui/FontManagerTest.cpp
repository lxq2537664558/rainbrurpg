...
{
  // No need for m_instance, directly using Singleton
  setupOgre();
}
...
/** Test the FontManager::loadFont() function
  *
  */
void FontManagerTest::testLoadFont()
{
  RainbruRPG::OgreGui::Font* font = OgreGui::FontManager::getSingleton()
    .loadFont("Iconiv2.ttf", 10);
}
